        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelegramLogin = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniqueSensorValue = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Data = table.Column<decimal>(type: "decimal(18,4)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SensorSettings_Sensors_SensorId",
                        column: x => x.SensorId,
                        principalTable: "Sensors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SensorSettings_Settings_SettingId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "Fire detector" },
                    { 3, "Motion and sound sensor" },
                    { 4, "Smart socket controller" },
                    { 5, "Keypad controller" },
                    { 6, "RFID sensor" },
                    { 7, "Lightning controller" },
                    { 8, "Fan controller" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SensorSettings_SensorId",
                table: "SensorSettings",
                column: "SensorId");

            migrationBuilder.CreateIndex(
                name: "IX_SensorSettings_SettingId",
                table: "SensorSettings",
                column: "SettingId");
        }
